      ...
      <div className="m-3">
        <div className="pb-[15px]">
          ...
          <div>
            ...
            {/* id */}
            <div>
              <p className="text-[0.85rem]">{`@${profile.id}`}</p>
            </div>
          </div>
          {/* introduce string */}
          <div>
            <span className="text-[0.85rem]">{profile.introduce}</span>
          </div>
        </div>
        ...
        <div className="flex justify-center items-center mb-[15px]">
          ...
          <div className="flex items-center rounded-[10px] bg-slate-200 px-[6px] mr-[5px]">
            <p className="mr-[4px] text-[0.85em]">following</p>
            <span className="font-bold">
              {makeUnitString(profile.relation?.following)}
            </span>
          </div>
          <div className="flex items-center rounded-[10px] bg-slate-200 px-[6px]">
            <p className="mr-[4px] text-[0.85em]">follower</p>
            <span className="font-bold">
              {makeUnitString(profile.relation?.follower)}
            </span>
          </div>
        </div>
        ...
        <div className="flex justify-center items-center flex-col mb-[15px]">
          <div className="flex flex-col items-center mb-[15px]">
            <p className="text-[0.85em]">Joined on</p>
            ...
            {profile.sns?.map((value, index) => {
              ...
              switch (value.type) {
                case 'EMAIL':
                  ...
                  data.src =
                    'https://cdn-icons-png.flaticon.com/512/712/712040.png';
                  break;
                case 'YOUTUBE':
